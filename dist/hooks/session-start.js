 ...
 */
function findProjectMemoryDir(dir) {
 ...
 */
function getRecentDailyLogs(memoryDir, maxLogs) {
    try {
        return fs
 ...
 */
function dateFromLogPath(logPath) {
