...
function getTotalEpisodes(db) {
    const row = db.prepare('SELECT COUNT(*) as cnt FROM episodes').get();
    return row.cnt;
}
...
function getRecentExtractions(db, limit = 10) {
    return db.prepare(`
